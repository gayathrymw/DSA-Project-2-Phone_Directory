...
public class Search_PhoneUser extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Search_PhoneUser frame = new Search_PhoneUser();
	...
	public Search_PhoneUser() {
		...
		lblNewLabel.setBounds(33, 42, 320, 29);
		contentPane.add(lblNewLabel);

		textField = new JTextField();
		textField.setBounds(347, 49, 213, 19);
